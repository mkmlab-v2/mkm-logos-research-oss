"""Template-catalog wire codec for zone_ko_premium_cs deep pack (B-track PoC).

Wire prefix CS_MASK — separate from BIZ_MASK (en business) and ZF_MASK (coding).
Mask token preservation (███, ****) is required for exact_restore.
"""

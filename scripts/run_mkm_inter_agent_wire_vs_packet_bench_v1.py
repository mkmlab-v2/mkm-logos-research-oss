#!/usr/bin/env python3
"""M8: wire envelope v1 vs Trust Packet JSON byte bench across corpora."""
...
DEFAULT_OUT = ROOT / "docs/final/artifacts/mkm_inter_agent_wire_vs_packet_bench_v1_latest.json"
...
from scripts.mkm_inter_agent_wire_envelope_v1 import new_session_id  # noqa: E402
...
def run_bench() -> dict[str, Any]:
    ...
    session_id = new_session_id("bench")
    ...
    return {
        "ok": True,
        "schema": "mkm_inter_agent_wire_vs_packet_bench_v1",
        ...
        "boundary_ack": "Byte-size only; not latency SLA or Track A bench.",
    }

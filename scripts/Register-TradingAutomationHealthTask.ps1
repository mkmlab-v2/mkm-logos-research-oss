param(
  ...
  [string]$TaskName = "\MKM-Trading-Automation-Health-30min",
...
$runner = Join-Path $WorkspaceRoot "scripts\Run-TradingAutomationHealthTask.ps1"
...
# Start in one minute to avoid "start time earlier than current" edge cases.

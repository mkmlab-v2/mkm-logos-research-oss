#!/usr/bin/env python3
"""H-PR1 chronicle HOLD alignment: PR1 news stress vs chronicle final_decision (B-track)."""
...
DEFAULT_OVERLAY = ROOT / "docs/final/artifacts/chronicle_history_news_signal_pr1_daily_overlay_latest.jsonl"
DEFAULT_HYP = ROOT / "docs/final/artifacts/biblical_resonance_hypotheses_v1.json"
DEFAULT_OUT = ROOT / "reports/biblical_history_h_pr1_chronicle_hold_alignment_latest.json"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="H-PR1 chronicle HOLD alignment eval.")
    ...
    payload = {
        "schema": "biblical_history_h_pr1_chronicle_hold_alignment_v1",
        "hypothesis_id": "H-PR1",
        ...
        "inputs": {
            ...
            "pr1_news_match_days": sorted(pr1_news_days),
        },
        "metrics": {
            "chronicle_hold_rate": round(chronicle_hold_rate, 6),
            "pr1_news_days_with_chronicle_overlap": compared,
            "hold_aligned_on_overlap_days": aligned,
            "hold_alignment_on_pr1_news_days": round(day_alignment_rate, 6) if day_alignment_rate is not None else None,
        ...
        "interpretation": {
            ...
            "note": (
                ...
                "with PR1 keyword news days only."
            ),
        },

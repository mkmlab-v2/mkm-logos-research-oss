...
@media(max-width:760px){.top{min-height:auto;padding-top:20px;padding-bottom:18px;align-items:flex-start;flex-direction:column;gap:13px}.nav{gap:16px}.hero{padding-top:62px;padding-bottom:38px}.hero h1{font-size:44px;word-break:keep-all;overflow-wrap:normal}.surface-grid{grid-template-columns:1fr}.surface-card{min-height:190px;padding:24px}.brief-head{padding-top:54px}.issue-row{grid-template-columns:1fr;gap:9px}.issue-id,.link-action{padding-top:0}}

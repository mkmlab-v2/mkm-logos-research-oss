#!/usr/bin/env python3
"""Mirror moment intent weights SSOT to no1kmedi public/data."""
...
DEFAULT_SRC = ROOT / "docs/final/artifacts/personadiary_moment_intent_weights_v1_latest.json"
DEFAULT_DST = ROOT / "projects/no1kmedi/public/data/personadiary_moment_intent_weights_v1.json"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if doc.get("schema") != "personadiary_moment_intent_weights_v1":
        ...
        return 1
    if doc.get("prophecy_vote") != "none" or doc.get("send_gate_default") != "HOLD":

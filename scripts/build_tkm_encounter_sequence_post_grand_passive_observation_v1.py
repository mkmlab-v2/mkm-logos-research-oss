#!/usr/bin/env python3
"""Build TKM encounter_sequence post-P58 grand vault passive observability rollup [HYPO]."""
...
OUT = ROOT / "reports/tkm_encounter_sequence_post_grand_passive_observation_v1_latest.json"
...
def build() -> dict[str, Any]:
    ...
    vault = grand_vault.get("vault_mirror") if isinstance(grand_vault.get("vault_mirror"), dict) else {}

    observation_ok = (
        p58.get("gate_ok") is True
    ...
    return {
        "schema": "tkm_encounter_sequence_post_grand_passive_observation_v1",
        "version": "1.0.0",
        ...
        "note_ko": "P59 post-grand passive+vault observability [HYPO][NON_GATING]; auto-training·Track A 금지.",
        "reproduce": "py scripts/build_tkm_encounter_sequence_post_grand_passive_observation_v1.py",
    }
        ...
        json.dumps(
            {
                ...
                "grand_vault_sync": doc.get("grand_export_bundle_vault_sync_ok"),

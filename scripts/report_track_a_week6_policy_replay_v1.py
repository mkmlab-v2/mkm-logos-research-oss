...
# Balance: 93
# Purpose: Consolidate Week-6 experiments into final policy replay decision.
# Keywords: track_a, week6, policy_replay, decision, commercialization
#!/usr/bin/env python3
...
E1 = ROOT / "docs" / "final" / "artifacts" / "track_a_week6_entropy_budget_sweep_v1.json"
E2 = ROOT / "docs" / "final" / "artifacts" / "track_a_week6_ngram_preserve_sweep_v1.json"
E3 = ROOT / "docs" / "final" / "artifacts" / "track_a_week6_clause_boundary_sweep_v1.json"
OUT = ROOT / "docs" / "final" / "artifacts" / "track_a_week6_policy_replay_v1.json"
...
def main() -> int:
    ...
    decision = (
        ...
        else "HOLD_W6_POLICY_REPLAY"
    )

    out_doc = {
        "schema": "track_a_week6_policy_replay_v1",
        ...
        "week6_summary": {
            "entry_decision": (pack.get("entry_condition") or {}).get("week5_decision"),
        ...
        "decision": decision,
        "next_action": (
            "Register Week-7 architecture-level redesign track."
            if decision == "HOLD_W6_POLICY_REPLAY"

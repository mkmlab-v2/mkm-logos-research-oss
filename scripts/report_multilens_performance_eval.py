...
def _semantic_pointer_v1(
    *,
    ...
    Additive only: callers still compute reconstruction_fidelity_jaccard from full text.
    """
    sp: dict[str, Any] = {
    ...
    sp["note"] = (
        "Additive semantic routing metadata; does not replace literal reconstruction metrics."
    )
    return sp

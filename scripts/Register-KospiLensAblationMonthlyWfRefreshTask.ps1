<#
.SYNOPSIS
  Register (or remove) monthly Scheduled Task: KOSPI lens ablation WF refresh (Charter R4).

.DESCRIPTION
  Runs: scripts/Run-KospiLensAblationMonthlyWfRefresh_v1.ps1
  B-track [HYPO]; research_only; non-gating.
...
.PARAMETER AtTime
  Local HH:mm (default: 09:00 — aligns with prior monthly full WF ops note).
#>
param(
    [switch]$Remove,
    [switch]$DryRun,
...
$runner = Join-Path $WorkspaceRoot "scripts\Run-KospiLensAblationMonthlyWfRefresh_v1.ps1"

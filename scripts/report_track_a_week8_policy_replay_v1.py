...
# Balance: 93
# Purpose: Consolidate Week-8 experiments into final policy replay decision.
# Keywords: track_a, week8, policy_replay, decision, commercialization
#!/usr/bin/env python3
...
E1 = ROOT / "docs" / "final" / "artifacts" / "track_a_week8_phrase_budget_micro_sweep_v1.json"
E2 = ROOT / "docs" / "final" / "artifacts" / "track_a_week8_confidence_restore_gate_sweep_v1.json"
E3 = ROOT / "docs" / "final" / "artifacts" / "track_a_week8_low_cost_rerank_sweep_v1.json"
OUT = ROOT / "docs" / "final" / "artifacts" / "track_a_week8_policy_replay_v1.json"
...
def _read_e4_config(pack: dict[str, Any]) -> tuple[float, bool]:
    ...
    e4 = next((x for x in exps if str(x.get("id")) == "W8-E4"), {})
...
def main() -> int:
    ...
    decision = (
        ...
        else "HOLD_W8_POLICY_REPLAY"
    )

    out_doc = {
        "schema": "track_a_week8_policy_replay_v1",
        ...
        "week8_summary": {
            "entry_decision": (pack.get("entry_condition") or {}).get("week7_decision"),
        ...
        "decision": decision,
        "next_action": (
            "Keep Track A commercialization HOLD and design Week-9 hypothesis pack."
            if decision == "HOLD_W8_POLICY_REPLAY"

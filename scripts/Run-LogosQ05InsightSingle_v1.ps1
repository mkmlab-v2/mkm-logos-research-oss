# q05 insight chain — CPU ANN + typology boost (hubris/trade volatility overlay).
...
Write-Host "[q05] CPU-only insight rebuild (hubris/trade overlay typology)" -ForegroundColor Cyan
...
Write-Host "[OK] q05 insight + gold eval" -ForegroundColor Green

#!/usr/bin/env python3
"""Dispatch webhook when genius human review gate is HOLD."""
...
DEFAULT_OUT = ART / "genius_reasoning_human_review_gate_dispatch_latest.json"
...
def main() -> int:
    ...
    out: dict[str, Any] = {
        "schema": "genius_reasoning_human_review_gate_dispatch_v1",
    ...
    if should_dispatch and webhook:
        payload = {
            "source": "genius_human_review_gate_v1",
            "severity": "WARNING",
            "status": status,
            "reasons": reasons,
            "current": current,

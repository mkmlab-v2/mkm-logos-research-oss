...
# Balance: 93
# Purpose: Consolidate Week-12 experiments into final policy replay decision.
# Keywords: track_a, week12, policy_replay, decision, commercialization
#!/usr/bin/env python3
...
E1 = ROOT / "docs" / "final" / "artifacts" / "track_a_week12_lane_weighted_router_sweep_v1.json"
E2 = ROOT / "docs" / "final" / "artifacts" / "track_a_week12_quality_tiebreak_replay_sweep_v1.json"
E3 = ROOT / "docs" / "final" / "artifacts" / "track_a_week12_confidence_quota_rollback_sweep_v1.json"
OUT = ROOT / "docs" / "final" / "artifacts" / "track_a_week12_policy_replay_v1.json"
...
def _read_e4_config(pack: dict[str, Any]) -> tuple[float, bool]:
    ...
    e4 = next((x for x in exps if str(x.get("id")) == "W12-E4"), {})
...
def main() -> int:
    ...
    decision = (
        "GO_W12_POLICY_REPLAY"
        if policy_floor_ok and integrity_ok and quality_tradeoff_ok
        else "HOLD_W12_POLICY_REPLAY"
    )

    out_doc = {
        "schema": "track_a_week12_policy_replay_v1",
        ...
        "week12_summary": {
            "entry_decision": (pack.get("entry_condition") or {}).get("week11_decision"),
        ...
        "decision": decision,
        "next_action": (
            "Keep Track A commercialization HOLD and design Week-13 hypothesis pack."
            if decision == "HOLD_W12_POLICY_REPLAY"

#!/usr/bin/env python3
"""Build en business deep pack promotion signoff envelope (separate from coding pack)."""
...
DEFAULT_OUT = ROOT / "docs/final/artifacts/compression_en_business_deep_pack_promotion_signoff_envelope_v1_latest.json"
CODING_SIGNOFF = ROOT / "docs/final/artifacts/compression_coding_deep_pack_promotion_signoff_envelope_v1_latest.json"
SPEC = ROOT / "docs/final/artifacts/compression_en_business_deep_pack_spec_v1_latest.json"
...
def build_envelope(*, gate_path: Path) -> dict[str, Any]:
    ...
    return {
        "schema": "compression_en_business_deep_pack_promotion_signoff_envelope_v1",
        ...
        "separate_from_coding_pack_signoff": _rel(CODING_SIGNOFF),
        "guardrail_ko": (
            "en business deep pack twin gate는 BIZ_MASK template-catalog wire 전용. "
            "ZF_MASK coding pack·wtt CS shortcap·Tier A ~86.7%와 헤드라인 합선 금지 (FAIL-COMP-004)."
        ),
        "guardrail_en": (
            "En business deep pack twin gate applies to BIZ_MASK template-catalog wire only. "
            "Do not merge with ZF_MASK coding pack, wtt CS shortcap, or Tier A ~86.7% headlines."
        ),
        "fallback_spec": "docs/final/artifacts/compression_en_business_deep_pack_fallback_spec_v1_latest.json",
        "signoff_checklist": "docs/final/artifacts/compression_en_business_deep_pack_signoff_checklist_v1_latest.json",
        "signoff_checklist_builder": "scripts/build_compression_en_business_deep_pack_signoff_checklist_v1.py",
        ...
        "forbidden_in_this_envelope": [
            ...
            "wtt_cs_shortcap_headline_merge",
            "tier_a_operational_pass_as_biz_pack_metric",
        ],
        "reproduce": [
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Build en business deep pack signoff envelope")

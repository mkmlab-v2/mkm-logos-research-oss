#!/usr/bin/env python3
"""Download NASDAQ Composite (^IXIC) daily OHLCV via yfinance — research SSOT only."""
...
DEFAULT_OUT = ROOT / "research" / "market_data" / "nasdaq_daily_external_yf.csv"


def main() -> int:
    ap = argparse.ArgumentParser(description=__doc__)
    ap.add_argument("--symbol", default="^IXIC")

param(
  ...
  [string]$TaskName = "\MKM-Trading-Observation-Loop-2H",
  [int]$EveryHours = 2,
...
$runner = Join-Path $WorkspaceRoot "scripts\Run-TradingObservationLoop.ps1"
...
Write-Host "SCHEDULE: EVERY ${EveryHours}H FROM $StartTime"

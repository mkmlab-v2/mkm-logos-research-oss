...
grep -q '^LOGOS_STUDIO_CONFLICT_RETRIEVAL=' "$ENV_FILE" \
  || echo 'LOGOS_STUDIO_CONFLICT_RETRIEVAL=1' >> "$ENV_FILE"
grep -q '^LOGOS_STUDIO_DYNAMIC_SYNTHESIS=' "$ENV_FILE" \
  || echo 'LOGOS_STUDIO_DYNAMIC_SYNTHESIS=1' >> "$ENV_FILE"

...
# Balance: 93
# Purpose: Consolidate Week-7 experiments into final policy replay decision.
# Keywords: track_a, week7, policy_replay, decision, commercialization
#!/usr/bin/env python3
...
E1 = ROOT / "docs" / "final" / "artifacts" / "track_a_week7_two_stage_arch_sweep_v1.json"
E2 = ROOT / "docs" / "final" / "artifacts" / "track_a_week7_semantic_chunk_sweep_v1.json"
E3 = ROOT / "docs" / "final" / "artifacts" / "track_a_week7_pareto_scorer_sweep_v1.json"
OUT = ROOT / "docs" / "final" / "artifacts" / "track_a_week7_policy_replay_v1.json"
...
def _read_e4_config(pack: dict[str, Any]) -> tuple[float, bool]:
    ...
    e4 = next((x for x in exps if str(x.get("id")) == "W7-E4"), {})
...
def main() -> int:
    ...
    decision = (
        ...
        else "HOLD_W7_POLICY_REPLAY"
    )

    out_doc = {
        "schema": "track_a_week7_policy_replay_v1",
        ...
        "week7_summary": {
            "entry_decision": (pack.get("entry_condition") or {}).get("week6_decision"),
        ...
        "decision": decision,
        "next_action": (
            "Keep Track A commercialization HOLD and design Week-8 hypothesis pack."
            if decision == "HOLD_W7_POLICY_REPLAY"

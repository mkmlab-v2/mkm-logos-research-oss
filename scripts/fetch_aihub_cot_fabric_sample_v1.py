#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""B-track [HYPO]: fetch one CoT-Fabric label zip via aihubshell (WSL)."""
...
def main() -> int:
    ...
    inner = (
        ...
        f"find {OUT_WSL} -name 'TL_*.zip' -exec cp {{}} {OUT_WSL_MNT}/TL_yangja.zip \\;"
    )

...
# Balance: 89
# Purpose: Run long-sample and latency gate for D27 mode-router decoder v2.
...
from scripts.run_l1_swap_typo_mode_router_decoder_v2 import _build_mode_pool, _score_candidate

ART = ROOT / "docs" / "final" / "artifacts"
OUT = ART / "l1_inverse_decoder_swap_typo_mode_router_decoder_v2_longsample_gate_v1.json"
...
def main() -> int:
    ...
    out_doc = {
        "schema": "l1_inverse_decoder_swap_typo_mode_router_decoder_v2_longsample_gate_v1",

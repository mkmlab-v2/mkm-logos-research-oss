#!/usr/bin/env python3
"""Build TKM encounter_sequence post-P52 export passive observability rollup [HYPO]."""
...
OUT = ROOT / "reports/tkm_encounter_sequence_post_export_passive_observation_v1_latest.json"
...
def build() -> dict[str, Any]:
    ...
    return {
        "schema": "tkm_encounter_sequence_post_export_passive_observation_v1",
        "version": "1.0.0",
        ...
        "note_ko": "P53 post-export passive+curated observability [HYPO][NON_GATING]; auto-training·Track A 금지.",
        "reproduce": "py scripts/build_tkm_encounter_sequence_post_export_passive_observation_v1.py",
    }
        ...
        json.dumps(
            {
                ...
                "export_sync": doc.get("export_sync_ok"),

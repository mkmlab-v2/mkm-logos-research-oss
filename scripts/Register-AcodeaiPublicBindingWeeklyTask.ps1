# Weekly: a-codeai public + open-bench runtime binding checks (no deploy).
#
# Usage:
#   pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/Register-AcodeaiPublicBindingWeeklyTask.ps1
#   pwsh ... -Unregister

param(
    [string]$StartTime = "09:15",
    [string]$WorkspaceRoot = "C:\workspace",
    [string]$TaskName = "MKM_Acodeai_PublicBinding_Weekly",
    [switch]$Unregister
)

$ErrorActionPreference = "Stop"

$routine = Join-Path $WorkspaceRoot "scripts\Invoke-AcodeaiPublicBindingRoutine_v1.ps1"

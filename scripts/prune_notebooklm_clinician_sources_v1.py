#!/usr/bin/env python3
"""Prune Clinician NL notebook to physician_gold slim-pack keep set.

SSOT pack: scripts/build_notebooklm_clinician_sync_pack_v1.py
"""
...
PACK_INDEX = ROOT / "reports" / "notebooklm_clinician_sync_pack_v1" / "index.json"
URL_FILE = ROOT / "reports" / "notebooklm_clinician_notebook_url_v1.txt"
OUT_DEFAULT = ROOT / "reports" / "notebooklm_clinician_prune_result_v1_latest.json"

KEEP_BASE_TITLES = {
    "00_clinician_lane_boundary_snippet.md",
    "MKM_DOMAIN_CLINICAL_LANE_V1.md",
    "CLINIC_CONSTITUTION_MVP_V1.md",
    "JEMA_AI_DOMAIN_POINTER_V1.md",
    ...
    "patient_care_bundle_generation_policy_v1.default.json",
    "patient_care_bundle_v1.schema.json",
    "clinic_constitution_mvp_capture_v1.schema.json",
}
...
def main() -> int:
    ...
    if not nb:
        raise SystemExit(
            "notebook UUID missing — set reports/notebooklm_clinician_notebook_url_v1.txt or --notebook-id"
        )
    ...
    doc = {
        "schema": "notebooklm_clinician_prune_result_v1",

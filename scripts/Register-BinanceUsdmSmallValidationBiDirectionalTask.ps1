param(
  ...
  [string]$TaskName = "\MKM-BinanceUSDM-SmallValidation-BiDirectional-2H",
  [int]$EveryHours = 2,
...
$runner = Join-Path $WorkspaceRoot "scripts\Run-BinanceUsdmSmallValidationBiDirectional.ps1"
...
Write-Host "SCHEDULE: EVERY ${EveryHours}H FROM $StartTime (bi-directional dry validation)"

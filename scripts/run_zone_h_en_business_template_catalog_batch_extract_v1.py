#!/usr/bin/env python3
"""Batch extract zone_h_en_business template seeds from multiple JSONL corpora."""
...
from scripts.compression_en_business_deep_pack_v1_lib import load_template_catalog  # noqa: E402
...
from scripts.merge_zone_h_en_business_template_prospect_v1_lib import max_prospect_index  # noqa: E402
...
DEFAULT_BATCH_REPORT = ROOT / "reports/zone_h_en_business_template_catalog_batch_extract_v1_latest.json"
DEFAULT_BATCH_ARTIFACT = ROOT / "docs/final/artifacts/zone_h_en_business_template_catalog_batch_extract_v1_latest.json"

DEFAULT_INPUTS = [
    "data/compression/fixtures/zone_h_en_business_corpus_extract_fixture_v1.jsonl",
    "data/compression/fixtures/zone_h_en_business_corpus_expand_v1.jsonl",
]
...
def run_batch_extract(
    ...
    *,
    ...
    return {
        "schema": "zone_h_en_business_template_catalog_batch_extract_v1",
        ...
        "reproduce": "py scripts/run_zone_h_en_business_template_catalog_batch_extract_v1.py --append-prospect",
    }


def main() -> int:
    ap = argparse.ArgumentParser(description="Batch extract en business template seeds")
    ...
    ap.add_argument("--append-prospect", action="store_true")
    args = ap.parse_args()

...
$SourceFiles = @(
    ...
    "docs\final\artifacts\lg_hs_business_plan_adapted_v1_2026-05-08.md",
    "docs\final\artifacts\lg_hs_pitch_preemptive_qna_report_v1_2026-05-08.md",
    "docs\final\artifacts\lg_hs_easy_visual_test_pack_v1_2026-05-08.md",
    "docs\final\artifacts\mkm_submission_packet_v1.md",
    "docs\final\artifacts\mkm_submission_camera_ready_compact_v1.md",
    "docs\final\artifacts\mkm_submission_table_figure_caption_templates_v1.md",
    "docs\final\artifacts\mkm_submission_rebuttal_template_v1.md",
    "docs\final\artifacts\mkm_submission_preflight_10min_checklist_v1.md",
    "docs\final\artifacts\two_track_submission_camera_ready_latest.json",
    "docs\final\artifacts\two_track_kdd_submission_template_latest.json",
    "docs\final\artifacts\external_message_claim_guard_latest.json",
    ...
    "docs\final\artifacts\original_corpus_regime_singularity_canon_insight_minimum_v1.json",
    ...
    "docs\final\artifacts\original_corpus_regime_singularity_canon_insight_explainability_benchmark_cohort_v1.jsonl",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_insight_explainability_benchmark_gate_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_insight_slice_stability_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_insight_slice_stability_quality_gate_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_weekly_brief_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_weekly_brief_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_weekly_brief_quality_gate_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_weekly_false_alert_review_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_operational_consistency_check_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_promotion_gate_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_promotion_gate_history_v1.jsonl",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_promotion_dashboard_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_promotion_dashboard_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_promotion_alert_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_promotion_alert_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_promotion_alert_history_v1.jsonl",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_promotion_readiness_report_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_promotion_readiness_report_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_promotion_go_no_go_v1.json",
    ...
    "docs\final\artifacts\original_corpus_regime_singularity_canon_nextday_observation_history_v1.jsonl",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_observation_streak_report_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_observation_streak_report_v1.md",
    ...
    "docs\final\artifacts\original_corpus_regime_singularity_canon_delta_cutoff_autotune_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_delta_cutoff_governance_gate_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_delta_cutoff_update_history_v1.jsonl",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_rehearsal_status_latest.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_rehearsal_status_history_v1.jsonl",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_rehearsal_weekly_summary_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_rehearsal_weekly_summary_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_day7_checkpoint_gate_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_v2.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_v2.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_vfinal_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_vfinal_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_v2_rollover_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_v2_rollover_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_v2_rollover_history_v1.jsonl",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_diff_v2_from_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_diff_v2_from_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_generation_diff_vfinal_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_generation_diff_vfinal_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_v2_stability_gate_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_baseline_freeze_v2_stability_gate_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_rehearsal_run_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_rehearsal_run_history_v1.jsonl",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_freeze_drift_gate_v1.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_freeze_drift_gate_v1.md",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_strict_freeze_drift_gate_history_v1.jsonl",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_ops_alert_runbook_latest.json",
    "docs\final\artifacts\original_corpus_regime_singularity_canon_ops_alert_runbook_latest.md",

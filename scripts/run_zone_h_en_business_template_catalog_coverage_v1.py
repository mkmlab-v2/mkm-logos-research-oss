#!/usr/bin/env python3
"""Run zone_h_en_business template catalog wire coverage eval (B-track)."""
...
from scripts.zone_h_en_business_template_catalog_coverage_v1_lib import (  # noqa: E402
    run_coverage_eval,
...
DEFAULT_REPORT = ROOT / "reports/zone_h_en_business_template_catalog_coverage_v1_latest.json"
DEFAULT_ARTIFACT = ROOT / "docs/final/artifacts/zone_h_en_business_template_catalog_coverage_v1_latest.json"


def main() -> int:
    ap = argparse.ArgumentParser(description="zone_h_en_business template catalog coverage")

...
When eval_context.emit_semantic_pointer is true, live evaluate_report uses emit_semantic_pointer on the reporter;
the first case semantic_pointer_v1 blob is echoed on CompressResponse.semantic_pointer (enterprise + live path only).

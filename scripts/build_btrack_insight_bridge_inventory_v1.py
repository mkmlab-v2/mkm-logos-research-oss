...
WATCHLIST: list[tuple[str, str]] = [
    ...
    ("lg_washer_voice_golden_train_jsonl", "docs/final/artifacts/lg_washer_voice_golden_train_v1.jsonl"),
    ("lg_washer_voice_golden_holdout_jsonl", "docs/final/artifacts/lg_washer_voice_golden_holdout_v1.jsonl"),
    ("lg_washer_voice_golden_split_manifest", "docs/final/artifacts/lg_washer_voice_golden_split_manifest_v1.json"),
    ("lg_washer_voice_golden_validate_script", "scripts/validate_lg_washer_voice_golden_jsonl_v1.py"),
    ("lg_washer_voice_golden_build_script", "scripts/build_lg_washer_voice_golden_jsonl_v1.py"),
    ("check_codebook_codepack_drift_script", "scripts/check_codebook_codepack_drift_v1.py"),
    ("check_lg_washer_measurement_gate_script", "scripts/check_lg_washer_measurement_gate_v1.py"),
    ("check_lg_washer_estimation_readiness_script", "scripts/check_lg_washer_estimation_readiness_v1.py"),
    ...
    ("prophecy_score_insight_overlay_view", "docs/final/artifacts/btrack_prophecy_score_insight_overlay_view_v1_latest.json"),
    ("prophecy_score_insight_overlay_view_schema", "docs/final/schemas/btrack_prophecy_score_insight_overlay_view_v1.schema.json"),
    ("prophecy_score_insight_overlay_view_script", "scripts/build_btrack_prophecy_score_insight_overlay_view_v1.py"),
    ...
    ("insight_sidecar_chain_task_register_script", "scripts/register_btrack_insight_sidecar_chain_task.ps1"),

...
$required = @(
    ...
    "projects\bitcoin-trading\ops\windows-rehearsal\register_fused_quant_pixel_sop_task.ps1",
    "projects\bitcoin-trading\ops\windows-rehearsal\register_fused_quant_pixel_sop_live_task.ps1",
    "projects\bitcoin-trading\ops\windows-rehearsal\switch_fused_quant_pixel_mode.ps1",
    "scripts\eval_prophecy_hit_rate_v1.py",
    "scripts\fetch_kospi_yfinance_csv.py",
    "tests\test_load_kospi_yf_rows.py",
    "scripts\verify_kospi_sasang_dynamics_holdout_v1.py",
    "scripts\Run-KospiSasangDynamicsVerify.ps1",
    "scripts\run_kospi_sasang_30y_validation_v1.py",
    "scripts\report_multiline_lane_gates_and_fusion_v1.py",
    "scripts\check_multiline_promotion_gates_v1.py",
    "scripts\check_multiline_fusion_readiness_v1.py",
    "scripts\Run-MultilinePromotionGateCheck.ps1",
    "scripts\Run-MultilineFusionReadinessGate.ps1",
    "scripts\Run-MultilinePromotionAndFusionReadiness.ps1",
    "scripts\Run-MultilineWeeklyChain.ps1",
    "scripts\build_multiline_weekly_summary_v1.py",
    "scripts\verify_kospi_biblical_wf_gates_v1.py",
    "scripts\verify_kospi_myeongri_wf_gates_v1.py",
    "scripts\verify_kospi_sasang_wf_gates_v1.py",
    ...
    "tests\test_track_a_shadow_corpus_eval_smoke.py",
    ...
    "tests\test_track_a_metering_chain_smoke.py",
    "scripts\run_autonomous_evolution_loop_draft_v1.py",
    "tests\test_autonomous_evolution_loop_draft_smoke.py",
    "scripts\core\domain_router.py",
    "scripts\run_cross_domain_compression_stress_v1.py",

...
$required = @(
    ...
    "docs\final\GLOBAL_ATOM_CORPUS_PROFILE_CHANGE_APPROVAL_CHECKLIST_V1.md",
    ...
    "docs\final\artifacts\logos_symbolic_event_map_dummy_v1.json",
    "docs\final\artifacts\logos_symbolic_event_map_iching_v1.json",
    "docs\final\artifacts\logos_symbolic_event_map_counterfactual_v1.json",
    "docs\final\artifacts\logos_symbolic_event_map_quantum_v1.json",
    ...
    "docs\final\artifacts\DOMAIN_GRAPH_OPS_DASHBOARD_SUMMARY_LATEST.md",
    "docs\final\artifacts\archive\cataloged\20260505T072109Z\docs\final\artifacts\freeze\global_atom_submission_20260428T095850Z\global_atom_network_academic_onepager_latest.json",
    ...
    "scripts\update_global_atom_profile_approval_log_v1.py",
    "scripts\check_global_atom_daily_outputs_freshness_v1.py",
    "scripts\run_global_atom_claim_lock_daily.ps1",
    "scripts\Register-GlobalAtomClaimLockDailyTask.ps1",
    ".github\workflows\logos-falsification-contrastive-smoke.yml",
    "tests\fixtures\logos_symbolic_event_backtest_news_holdout_v1.jsonl",
    "tests\fixtures\logos_symbolic_event_backtest_labels_holdout_v1.jsonl",

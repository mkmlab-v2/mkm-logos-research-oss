...
$required = @(
    ...
    "docs\final\schemas\pre_news_snapshot_v1.schema.json",
    "scripts\build_pre_news_snapshot_v1.py",
    "scripts\pre_news_dual_regime_adapter_v1.py",
    "scripts\dry_run_pre_news_dual_regime_v1.py",
    "scripts\send_pre_news_bridge_stub_telegram_v1.py",
    "scripts\run_pre_news_morning_chain_v1.ps1",
    "scripts\register_pre_news_morning_chain_task.ps1",
    "scripts\run_daily_prophecy_then_pre_news_v1.ps1",
    "scripts\run_ssh_shadow_pre_news_chain_v1.ps1",
    "scripts\evolve_pre_news_bench_inputs_v1.py",
    "scripts\run_local_min_verification_5lines_v1.ps1",
    "scripts\run_local_24h_ops_chain_v1.ps1",
    "scripts\register_local_24h_ops_chain_task.ps1",
    "scripts\alert_local_trading_mode_transition_v1.py",
    "scripts\run_local_live_recheck_30m_v1.ps1",
    "scripts\register_local_live_recheck_30m_task.ps1",
    "scripts\run_pre_news_weekly_candidate_review_v1.py",
    "scripts\register_pre_news_weekly_candidate_review_task.ps1",
    "scripts\templates\pre_news_bench_inputs_v1.example.json",
    "tests\test_build_pre_news_snapshot_v1.py",
    "tests\test_pre_news_dual_regime_adapter_v1.py",
    "tests\test_send_pre_news_bridge_stub_telegram_v1.py",
    "tests\test_evolve_pre_news_bench_inputs_v1.py",
    "tests\test_alert_local_trading_mode_transition_v1.py",
    "tests\test_run_pre_news_weekly_candidate_review_v1.py"
)

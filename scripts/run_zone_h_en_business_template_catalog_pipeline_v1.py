#!/usr/bin/env python3
"""One-click zone_h_en_business template catalog pipeline: batch → coverage → merge dry-run.
...
BATCH = ROOT / "scripts/run_zone_h_en_business_template_catalog_batch_extract_v1.py"
COVERAGE = ROOT / "scripts/run_zone_h_en_business_template_catalog_coverage_v1.py"
MERGE = ROOT / "scripts/merge_zone_h_en_business_template_prospect_to_catalog_v1.py"
DEFAULT_PIPELINE_REPORT = ROOT / "reports/zone_h_en_business_template_catalog_pipeline_v1_latest.json"
DEFAULT_PIPELINE_ARTIFACT = ROOT / "docs/final/artifacts/zone_h_en_business_template_catalog_pipeline_v1_latest.json"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="zone_h_en_business template catalog pipeline")
    ...
    report = {
        "schema": "zone_h_en_business_template_catalog_pipeline_v1",
        ...
        "steps": steps,
        "reproduce": "py scripts/run_zone_h_en_business_template_catalog_pipeline_v1.py",
    }

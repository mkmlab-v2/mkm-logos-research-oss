<#
.SYNOPSIS
  Register (or remove) monthly genius reasoning refresh scheduled task.
#>
param(
    [switch]$Remove,
    [string]$TaskName = "MKM_GeniusReasoning_MonthlyRefresh",
    [string]$MonthlyAt = "08:30",
    [int]$DayOfMonth = 1
)

$ErrorActionPreference = "Stop"
$workspaceRoot = "C:\workspace"
$runner = Join-Path $workspaceRoot "scripts\run_genius_reasoning_monthly_refresh_v1.ps1"

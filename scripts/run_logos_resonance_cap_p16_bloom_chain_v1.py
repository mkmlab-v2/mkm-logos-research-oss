#!/usr/bin/env python3
"""P16 bloom resonance_cap 112→120 bloom slice deepen (B-track, HYPO).

Oracle lane label P27; narrative count frozen at 200; inter-hop not re-run.

Reproducible:
  py scripts/run_logos_resonance_cap_p16_bloom_chain_v1.py
"""
    ...
    if not args.skip_pytest:
        proc = subprocess.run(
            [
                ...
                "-m",
                "pytest",
                "tests/test_logos_resonance_cap_p16_bloom_v1.py",
                "-q",
            ],
            cwd=ROOT,
            check=False,
        ...
        if proc.returncode != 0:
            return proc.returncode
        print("OK: pytest resonance_cap p16 bloom")

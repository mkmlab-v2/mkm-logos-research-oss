...
type MarketingLegacyHomePageProps = {
  searchParams?: {
    preset?: string;
  };
};

/** Classic jema-ai.com marketing landing — `/home` or `/?legacy_home=1`. */
export function MarketingLegacyHomePage({ searchParams }: MarketingLegacyHomePageProps) {
  const c = siteCopy;
  const heroCtaLinks = {
        ...
        <section id="brand-motion" aria-labelledby="brand-motion-title">
          <div className="brand-motion-grid">
            <article className="brand-motion-copy">
              ...
              <p className="section-lead">{c.concept_block.lead}</p>

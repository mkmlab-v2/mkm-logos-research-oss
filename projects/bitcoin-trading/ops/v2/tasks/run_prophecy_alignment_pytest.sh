...
cd "${WORKSPACE_ROOT}"
exec "${PY}" -m pytest tests/test_add_entry16_source_and_rejudge.py tests/test_logos_state_mapping_v1_snapshot.py tests/test_cross_ref_dss_schema.py tests/test_entry16_source_hunt_log.py tests/test_entry16_source_hunt_summary.py tests/test_entry16_promotion_gate.py tests/test_waiting_queue_monthly_check_log.py tests/test_btrack_phase3_snapshot_sync.py tests/test_sasang_cross_ref_draft.py tests/test_myeongni_16_state_transition_report.py tests/test_myeongni_16_state_topflows_report.py tests/test_myeongni_16_state_topflow_interpretation_report.py tests/test_myeongni_topflow_integrated_report.py tests/test_multilens_performance_eval_report.py tests/test_multilens_performance_eval_report_v2.py tests/test_myeongni_insight_observation_log.py -q --tb=short

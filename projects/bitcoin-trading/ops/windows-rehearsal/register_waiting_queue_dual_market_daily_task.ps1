param(
    [string]$TaskName = "Bitcoin-WaitingQueue-DualMarket-Daily-Strict",
...
$runner = Join-Path $projectRoot "ops\windows-rehearsal\run_waiting_queue_dual_market_daily.ps1"
...
if (-not (Test-Path $runner)) {
    throw "Dual market daily wrapper not found: $runner"
}

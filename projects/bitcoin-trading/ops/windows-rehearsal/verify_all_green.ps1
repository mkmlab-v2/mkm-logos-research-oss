...
$steps = @(
    ...
    @{
        ...
        cmd = @("powershell", "-NoProfile", "-ExecutionPolicy", "Bypass", "-File", (Join-Path $ops "verify_jemaai_showroom_deploy.ps1"), "-GatewayBaseUrl", "https://api.jemaai.cloud", "-AutoFixLocal")
    },
    @{

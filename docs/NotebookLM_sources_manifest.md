...
| **이론·수학화 (B, internal)** | `MKM_THEORY_MATHEMATIZATION` · MCP `23-mkm-theory-mathematization-2026q2` | `py scripts/build_notebooklm_theory_mathematization_pack_v1.py` → `reports/notebooklm_theory_mathematization_pack_v1/` (`mkm_theory_mathematization_canon_v1_latest.md`, `MKM_WORLDVIEW_AND_PHILOSOPHY_CONSTITUTION_V1.md`, `mkm12_75_formulas_ssot_v1_latest.json`, `MKM12_L0_L1_L2_CLAIMS_TAGGED_FACTCHECK_2026-04-09.md`, vault mirror 인덱스·봉인판) | 75식 HYPO·금지목록·WORLDVIEW §5; **Track A·K-Startup 격벽**; 압축 SLA·실매매 GO 금지 |
...
**금지:** `MKM_CORE_FACT`에 명리·사업·이벤트·**이론 75식 헌법** 원본을 **추가로** 섞어 넣기.

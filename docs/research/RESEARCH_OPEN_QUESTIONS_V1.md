...
| RQ-022 | OPEN | **Saving the News** — Phase1·2 PoC **내부 COMPLETE** · Phase3·라이브 **미실시** | Phase2 `phase2_matrix_view` → **WATCH**·conflict false · `promote_to_phase3: true`(내부) · NEWS-RT 160행 ~39% | blueprint · `Run-SavingTheNewsPhase2Matrix_v1.ps1` · Track C 1p | Phase3 Truth Gating API · CMS · 법무 · 라이브 NEWS-RT |

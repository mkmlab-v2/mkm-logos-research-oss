...
- **last_reviewed_utc:** 2026-05-15 — 지휘관 승인: R&D·파일럿 KPI·최종 면책 **SSOT 동결 지연** + 민감 액션 **구조 Lock**을 `TRACK_C`·`PUBLIC`(v1.3)·본 표에 반영. RQ-009 **`OPEN` 유지**(법무 (D) 확정·실측 KPI 승격 일정 잔여).

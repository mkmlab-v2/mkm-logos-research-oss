...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `51af0115ba8cb3330d38cb2b0c846823f260c3a9` |
| **HEAD (short)** | `51af0115ba` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `51af0115ba` — `docs: battleboard Handoff matches HEAD 11db49d6ba` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `d7eb184a5c4e8b45391b0f890f9e1b07acf7c85f` |
| **HEAD (short)** | `d7eb184a5c` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `d7eb184a5c` — `docs: battleboard Handoff matches HEAD 6f02c257df` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

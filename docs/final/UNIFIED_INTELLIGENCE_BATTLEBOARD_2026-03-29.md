...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `9400de7175df9159245a56500752b903f7c8b9d8` |
| **HEAD (short)** | `9400de7175` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `9400de7175` — `docs: battleboard Handoff sync to 9dd148abd6` |

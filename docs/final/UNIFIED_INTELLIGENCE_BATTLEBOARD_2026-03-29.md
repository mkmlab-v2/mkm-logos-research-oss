...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `84be39afec6422b18d4353c4e2cee946091d8acb` |
| **HEAD (short)** | `84be39afec` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `84be39afec` — `docs: battleboard Handoff sync to 9400de7175` |

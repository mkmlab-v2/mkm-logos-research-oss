...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `f7bc6109f1c0e98bcfa0fbf3e41d1e04760c03e2` |
| **HEAD (short)** | `f7bc6109f1` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `f7bc6109f1` — `docs: battleboard Handoff matches HEAD d7eb184a5c` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

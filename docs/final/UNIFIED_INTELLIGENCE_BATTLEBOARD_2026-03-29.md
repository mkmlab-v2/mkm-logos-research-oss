...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `9dd148abd61f66bdb13d731cb7c339b8a51caaff` |
| **HEAD (short)** | `9dd148abd6` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `9dd148abd6` — `docs: battleboard Handoff sync to 67a3afb4e9` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

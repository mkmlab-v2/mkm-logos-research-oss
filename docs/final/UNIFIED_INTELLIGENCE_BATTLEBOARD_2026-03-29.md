...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `5948f9506022325e2b94c02ac202f29027eaada9` |
| **HEAD (short)** | `5948f95060` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `5948f95060` — `docs: battleboard Handoff matches HEAD dffc723607` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

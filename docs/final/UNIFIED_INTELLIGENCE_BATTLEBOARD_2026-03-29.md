...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `d8954c69d97a09f9482a1095bbdf1d27fbc69ea7` |
| **HEAD (short)** | `d8954c69` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `d8954c69` — `docs: battleboard Handoff matches HEAD baed04e654` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

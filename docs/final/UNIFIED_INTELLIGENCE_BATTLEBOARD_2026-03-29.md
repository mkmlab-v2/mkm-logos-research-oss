...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `e8a0e945fa9a7bcb90234fdbbfb97b3b03b6c686` |
| **HEAD (short)** | `e8a0e945fa` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `e8a0e945fa` — `docs: battleboard Handoff SSOT line (drop stale 51af0115ba ref)` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

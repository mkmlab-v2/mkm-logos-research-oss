...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `08c5f7695737f07f3a136d43396e8f881763b47f` |
| **HEAD (short)** | `08c5f76957` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `08c5f76957` — `docs: battleboard Handoff matches HEAD 15fdefee46` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `dffc723607f7159df90c85ad9f025ff0b3e52e2a` |
| **HEAD (short)** | `dffc723607` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `dffc723607` — `docs: battleboard Handoff matches HEAD 08c5f76957` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

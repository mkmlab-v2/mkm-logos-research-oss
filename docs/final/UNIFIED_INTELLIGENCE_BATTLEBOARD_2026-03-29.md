...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `2e92a4c5c96cd00f5309b0790df90902c8f4c82b` |
| **HEAD (short)** | `2e92a4c5` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `2e92a4c5` — `docs: battleboard Handoff matches HEAD d8954c69` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

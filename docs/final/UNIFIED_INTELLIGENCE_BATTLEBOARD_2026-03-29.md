...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `79a511f070266cec6267d692602d830db2343501` |
| **HEAD (short)** | `79a511f070` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `79a511f070` — `docs: battleboard Handoff HEAD/SSOT sync to tip 932694d620` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

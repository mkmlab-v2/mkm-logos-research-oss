...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `8dcd0a884410f60d0c44a6bfdbf72cdfe0399206` |
| **HEAD (short)** | `8dcd0a8844` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `8dcd0a8844` — `docs: battleboard Handoff matches HEAD f7bc6109f1` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

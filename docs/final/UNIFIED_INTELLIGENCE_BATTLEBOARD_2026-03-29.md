...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `1cee4a841b31f382f3bb4886b131ac5c4302c8ca` |
| **HEAD (short)** | `1cee4a841b` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `1cee4a841b` — `docs: battleboard Handoff sync to 84be39afec` |

...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `932694d620e468b7568e067609eccc3945aa2ddc` |
| **HEAD (short)** | `932694d620` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `932694d620` — `docs: battleboard Handoff SSOT line (drop stale 51af0115ba ref)` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

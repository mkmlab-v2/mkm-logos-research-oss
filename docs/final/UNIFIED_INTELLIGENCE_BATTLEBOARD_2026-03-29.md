...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `0217ab314e5d1f7eb630c42f7570f2bce2368060` |
| **HEAD (short)** | `0217ab314e` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `0217ab314e` — `docs: battleboard Handoff matches HEAD 4f960d8368` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

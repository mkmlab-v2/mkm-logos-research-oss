...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `baed04e6541b4f8cafe13ba26399b855c7e91da8` |
| **HEAD (short)** | `baed04e654` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `baed04e654` — `docs: battleboard Handoff matches HEAD 0217ab314e` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

...
|------|-----|
| **브랜치** | `main` |
| **HEAD (full)** | `15fdefee4673da2cc7de8c97b18b937e4230ca1c` |
| **HEAD (short)** | `15fdefee46` |
| **SSOT 커밋 (integrity_guard·golden ACTUAL + 전황판 Handoff)** | `15fdefee46` — `docs: battleboard Handoff matches HEAD 2e92a4c5` (integrity_guard·golden ACTUAL 스냅샷·ci 전환 등은 이전 커밋 히스토리 참조) |

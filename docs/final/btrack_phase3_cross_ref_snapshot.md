...
```json
{
  ...
  "entries": [
    ...
    },
    {
      ...
      "satellite_ref": "11QT (11Q19) | loc=cols.XLVI-XLVII, line=TBD | refs=Yadin 1977, DJD XXIII | status=partial_anchor_verified (column-range)",
      "source_id": "11QT (11Q19) | loc=cols.XLVI-XLVII, line=TBD | refs=Yadin 1977, DJD XXIII | status=partial_anchor_verified (column-range)",
      "corpus_type": "dss",
      "link_type": "temporal",
      "confidence": null,
      "artifact_path": null,

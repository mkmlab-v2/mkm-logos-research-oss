...
```json
{
  ...
  "entries": [
    ...
    },
    {
      ...
      "satellite_ref": "1QpHab (1Q15) | loc=col.VII, line=TBD | refs=St.Mark's I (ASOR 1950), DSS Study Edition (Brill) | status=partial_anchor_verified (column)",
      "source_id": "1QpHab (1Q15) | loc=col.VII, line=TBD | refs=St.Mark's I (ASOR 1950), DSS Study Edition (Brill) | status=partial_anchor_verified (column)",
      "corpus_type": "dss",
      "link_type": "thematic",
      "confidence": null,
      "artifact_path": null,
    ...
    },
    {
      ...
      "satellite_ref": "11Q5 | loc=etcbc linesSort-2020-07-14: 11Q5-18 line-buckets sampled (1-9); MT Ps.4.6 verse mapping line remains TBD | refs=DJD IV (Sanders 1965), etcbc-dss log | status=partial_anchor_verified (scroll+line-buckets)",
      "source_id": "11Q5 | loc=etcbc linesSort-2020-07-14: 11Q5-18 line-buckets sampled (1-9); MT Ps.4.6 verse mapping line remains TBD | refs=DJD IV (Sanders 1965), etcbc-dss log | status=partial_anchor_verified (scroll+line-buckets)",
      "corpus_type": "dss",
      "link_type": "lexical",
      "confidence": null,
      "artifact_path": null,
      ...
      "note": "Bench policy: lexical 정렬 후보. 승격 조건=11Q5 col/line↔MT Ps.4.6 매핑 확인 + 비정경 해석 레이어 미주입. 반증 훅=열/행 매핑 불일치 또는 단순 어휘 중복만 남는 경우. NL notebook_query(2026-03-30, conv 46c6c47a): witness 정합도 M/L, verify 전 단계로 승격 보류. NL cross_notebook_query(2026-03-30): DSS-only/Fusion/Phase3 전부에서 fragment/col-line 'missing anchor' 확인. Local evidence (2026-03-30): etcbc-dss log linesSort-2020-07-14에서 11Q5-18 line-bucket 표기가 확인되어 partial_anchor로 상향(정경 verse line 매핑은 미완)."
    },
    {
      "entry_id": "ENTRY_13",
      "canonical_ref": "Ps.5.2",
      "satellite_ref": "11Q5 | loc=etcbc linesSort-2020-07-14: 11Q5-18 line-buckets sampled (1-9); MT Ps.5.2 verse mapping line remains TBD | refs=DJD IV (Sanders 1965), etcbc-dss log | status=partial_anchor_verified (scroll+line-buckets)",
      "source_id": "11Q5 | loc=etcbc linesSort-2020-07-14: 11Q5-18 line-buckets sampled (1-9); MT Ps.5.2 verse mapping line remains TBD | refs=DJD IV (Sanders 1965), etcbc-dss log | status=partial_anchor_verified (scroll+line-buckets)",
      "corpus_type": "dss",
      "link_type": "lexical",
      "confidence": null,
      "artifact_path": null,
      ...
      "note": "Bench policy: lexical 정렬 후보. 승격 조건=11Q5 Ps.5 witness가 MT Ps.5.2 호출 구조와 합치. 반증 훅=예배 문체 일반론으로 환원되어 state 11 특이성이 사라지는 경우. NL notebook_query(2026-03-30, conv 46c6c47a): witness 정합도 M/L, verify 전 단계로 승격 보류. NL cross_notebook_query(2026-03-30): DSS-only/Fusion/Phase3 전부에서 fragment/col-line 'missing anchor' 확인. Local evidence (2026-03-30): etcbc-dss log linesSort-2020-07-14에서 11Q5-18 line-bucket 표기가 확인되어 partial_anchor로 상향(정경 verse line 매핑은 미완)."
    },
    {
      "entry_id": "ENTRY_14",

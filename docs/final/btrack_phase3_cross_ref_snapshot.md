...
**용도**: NotebookLM Phase3 대조 노트 전용. 정본 SSOT는 `docs/final/artifacts/CROSS_REF_DSS_TO_STATES_DRAFT.json`(v2). 아래 코드펜스·평문 엔트리는 2026-03-30 `link_type` 세분화와 동기화.
...
```json
{
  ...
  "generated_at_utc": "2026-03-30T18:30:00+00:00",
  "entries": [
    {

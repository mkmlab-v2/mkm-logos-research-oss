...
- **last_updated_utc:** 2026-05-12T06:06:04Z
- **owner:** (선택)
...
- **2026-05-12T06:06:04Z** — 아테나 자동화: `automation_registry`에 `athena_automation`+`optional`, reconcile은 **optional이고 작업 미등록일 때만** drift 제외, `scripts/Invoke-AthenaAutomationRegistryCheck.ps1` 커밋됨; **등록된 작업이 Disabled면 optional과 무관하게 drift**; 다음 `internal` push

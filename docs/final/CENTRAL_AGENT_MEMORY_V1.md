...
- **last_updated_utc:** 2026-05-14T19:15:42Z
- **owner:** (선택)
...
- **2026-05-14T19:15:42Z** — 융합: gitea fetch/prune·dev=main 동일 SHA 시 원격 dev 삭제·로컬 dev는 gitea/main 추적; SSOT는 CENTRAL 한 줄+MKM_SHOWROOM 진행 로그 한 행(스냅샷 장문 이중 금지)
- **2026-05-14T19:11:06Z** — 권장안: STT rows=18, P0 719, pytest 26, prophecy closure_ok+SafeOps ok, fact_lock_bundle -SafeOpsIgnoreLiveSync exit0 (~162s)
- **2026-05-14T19:07:53Z** — 권장안: verify_p0 719 OK; push-internal; sync_showroom_to_vps -RefreshStaging scp OK(nginx reload 생략); jemaai poll HEAD 확인
- **2026-05-14T19:07:16Z** — showroom sync + JEMAAI_VPS_RELOAD_NGINX=1: scp OK, nginx -t OK, reload OK (443 warn only)
- **2026-05-14T19:03:16Z** — showroom VPS scp OK /var/www/jemaai; jemaai.cloud board_minimal HEAD 200
- **2026-05-14T19:02:52Z** — 정리: artifact·reports restore; feat(ops) a073d8 푸시·SoloDev로 gitea/main FF 동기; 워킹트리 clean
- **2026-05-14T18:59:37Z** — gitea/main=dev showroom+RQ-011; P0 719 + showroom/RQ011 pytest 13 pass
- **2026-05-14T18:53:57Z** — SoloDev: stash→merge dev→gitea/main FF→push main→stash pop; main=dev=68786312cc; 로컬 WIP·스테이징 잡음 복원
- **2026-05-14T18:51:09Z** — 자동: push-internal dev→internal up-to-date; verify_p0 719 OK; 워킹트리 로컬 산출물·미추적 다수(커밋 대상 아님)
- **2026-05-14T18:47:52Z** — jemaai: run_jemaai_cloud_completion_chain.ps1 -SkipP1AB exit0 (~3m); autopilot OK; Safe ops surface degraded WARN(verify exit0); MVP path checks OK
- **2026-05-14T18:45:07Z** — Run-MkmOpsFullPush_v1 OK 2026-05-14T18:45:07Z
- **2026-05-14T18:44:14Z** — 권장 사이클: STT rows=16, P0 719, pytest 26, prophecy closure_ok, fact_lock_bundle exit0 (~181s); SafeOps tail degraded warn only
- **2026-05-14T18:41:07Z** — Showroom: sync_showroom_to_vps scp 확장(Trust+saju 4종)+RefreshStaging+nginx reload exit0; jemaai.cloud 8정적 경로 HEAD 200 확인
- **2026-05-14T18:38:15Z** — Showroom: JEMAAI_VPS_RELOAD_NGINX=1 sync_showroom_to_vps OK — scp + ssh nginx -t + reload; nginx syntax ok (기존 443 protocol options warn 다수, 치명 아님)
- **2026-05-14T18:34:24Z** — Showroom 융합: sync_showroom_to_vps exit0 /var/www/jemaai; prod board_minimal QA OK (degraded/WARNING/HOLD, riskPillClass); nginx reload skipped (JEMAAI_VPS_RELOAD_NGINX unset); 소액매매 VPS 설정 변경 없음
- **2026-05-14T18:32:43Z** — sync_showroom_to_vps OK → srv1101456 /var/www/jemaai; board_minimal riskPillClass fix live; nginx reload skipped (JEMAAI_VPS_RELOAD_NGINX unset)
- **2026-05-14T18:32:31Z** — Run-MkmOpsFullPush_v1 OK 2026-05-14T18:32:31Z
- **2026-05-14T18:29:45Z** — jemaai.cloud 브라우저 QA: poll OK; board_minimal JS riskPillClass 누락 수정(jemaai-cloud-mvp+.showroom_staging) — 프로덕션 반영은 sync_showroom_to_vps 필요
- **2026-05-14T18:23:43Z** — Run-MkmOpsFullPush_v1 OK 2026-05-14T18:23:43Z
- **2026-05-14T18:20:42Z** — jemaai: GET api/public-events/latest 200 (CF+VPS); HEAD=501 unsupported — 모니터링은 GET; VPS 127.0.0.1:8788 PublicEventGateway listening

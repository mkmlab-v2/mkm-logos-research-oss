...
- **last_updated_utc:** 2026-05-12T22:30:00Z
- **owner:** (선택)
...
- **2026-05-12T22:30:00Z** — Pack 0-B §2.3: profiles JSON(추적)·`eval_myeongri_deterministic_lora_golden_fit_v1`·`storage/adapters/myeongri_deterministic_lora_v0/`·pytest+P0+CI; `models/**` gitignore 회피

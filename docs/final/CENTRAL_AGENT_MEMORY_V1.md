...
- **last_updated_utc:** 2026-05-14T08:00:00Z
- **owner:** (선택)
...
- **2026-05-13T17:16:34Z** — 세션 종료: gematria–명리 수학 v1·athena_checkpoint prepend·internal 푸시 완료; 워킹트리 clean
...
|------|----------------------------------------|
| 2026-05-14 (퓨전 헬스 Logos insight skip — env 자동) | `run_workspace_automation_health.ps1` 퓨전 스모크: User/머신 환경 **`MKM_HEALTH_FUSION_SKIP_LOGOS_INSIGHT_BUNDLE`** truthy 시 Invoke에 **`-SkipLogosInsightBundle`** 자동 전달(스위치 미사용 시); `.env.example`·`projects/bitcoin-trading/ops/windows-rehearsal/sync_required_env_to_user.ps1` 키 목록·CONSTITUTION §1.3.1·루트 `AGENTS.md` 정렬. |

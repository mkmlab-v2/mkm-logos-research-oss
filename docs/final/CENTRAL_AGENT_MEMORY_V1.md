...
- **last_updated_utc:** 2026-05-13T19:30:00Z
- **owner:** (선택)
...
- **2026-05-13T14:50:56Z** — B2G 통제 무결성 부록 **v0.2 (Freeze)**: §1.1 Fact-Lock 교정(과장 삭제·니치 실증→CDSS 확장·SaMD·규제 종속)·§2~§8 유지. 제출은 지휘관 수동.
...
|------|----------------------------------------|
| 2026-05-13 (B2G 통제 무결성 부록 v0.2) | 제안 부록 SSOT `docs/final/B2G_CONTROL_INTEGRITY_PROPOSAL_ANNEX_V1.md`: §1.1 Wedge+CDSS 로드맵(Fact-Lock)·§2 보안·리스크(Anthropic 각주)·한·영·§4 URL·미니표·DoD. |

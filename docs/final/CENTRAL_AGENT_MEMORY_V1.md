...
- **2026-05-14T04:00:00Z** — `Verify-AramaicMvpDailyTaskReadiness.ps1`에 `survivor_health_alert_dry_run_switch_in_task_action` 출력·CONSTITUTION 표 630/631 재정합·`AGENTS`/`CLAUDE` Aramaic survivor dry-run 포인터.
- **2026-05-14T03:00:00Z** — Track T dry-run: 체인 `MKM_ARAMAIC_SURVIVOR_HEALTH_ALERT_DRY_RUN` 환경 폴백·`.env.example`·CONSTITUTION 표(원클릭·일일·즉시·Raw-OOS·§16) 정합.

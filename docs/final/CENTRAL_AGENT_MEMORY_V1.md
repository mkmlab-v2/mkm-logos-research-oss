...
- **last_updated_utc:** 2026-05-14T14:00:00Z
- **owner:** (선택)
...
- **2026-05-13T14:50:56Z** — B2G 통제 무결성 부록 **v0.2.1**: v0.2 본문 동결·연계 절에 1p 기술요약 준비 목차 포인터. `docs/final/B2G_TECH_DISCLOSURE_ONEPAGER_PREP_V1.md` v0.1. 제출은 지휘관 수동.
- **2026-05-14** — 내부 **시맨틱+RAG+4D 보정** 설계도 목차 v0.1: `docs/final/INTERNAL_SEMANTIC_RAG_4D_ARCH_OUTLINE_V1.md`(대외·제안 합선 금지, B-track·품질용).

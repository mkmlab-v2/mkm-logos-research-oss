...
## Track A Sprint Update (2026-04-15, W15-Pack)

- 실행: `py scripts/build_track_a_week15_hypothesis_pack_v1.py`
- 산출물: `docs/final/artifacts/track_a_week15_hypothesis_pack_v1.json`
- 결과: Week-15 실험 팩 등록 완료 (`track_a_week15_hypothesis_pack`)
- 기준선: `saving=0.46911`, `jaccard=0.84884`, `integrity=1.0`
- 진입 조건: `week14_decision=HOLD_W14_POLICY_REPLAY`, `policy_floor_locked=0.49`, `quality_tradeoff_flag=true`, `best_saving_seen=0.46911`, `best_jaccard_seen=0.84884`
- 실험 구성: W15-E1(selective floor unlock), W15-E2(confidence replay crossover), W15-E3(adaptive throttle veto), W15-E4(policy replay)
- 다음 1스텝: W15-E1(`run_track_a_week15_selective_floor_unlock_sweep_v1.py`) 구현/실행으로 첫 sweep 결과 확보

...
## Track A Sprint Update (2026-04-15, W12-E4)

- 실행: `py scripts/report_track_a_week12_policy_replay_v1.py`
- 산출물: `docs/final/artifacts/track_a_week12_policy_replay_v1.json`
- 결과: `decision=HOLD_W12_POLICY_REPLAY`
...
- 다음 1스텝: Week-13 가설 팩 등록(`build_track_a_week13_hypothesis_pack_v1.py`)로 quality_tradeoff_flag 해소 중심 실험 설계

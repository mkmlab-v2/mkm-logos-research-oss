# B-Track Apocrypha — 1에녹(Ethiopic Enoch) 제10장 발췌 (아자젤·심판)

**역할**: 외경 전용 NotebookLM 노트에 **문헌 본문** 근거를 추가. B-Track 연구용. A-Track·실매매와 무관.

## 출처

**R.H. Charles** 영역, *The Book of Enoch*, Wikisource.  
https://en.wikisource.org/wiki/The_Book_of_Enoch_(Charles)/Chapter_10

## 제10장 발췌 (Azâzêl / Raphael, 영어)
...
*(같은 장 후반: Semjâzâ, Watchers, 심판·불의 구렁 등이 이어짐 — 전문은 위 Wikisource 참조.)*

## 주제 키워드 (학술)

타락한 천사(Watchers)에 대한 심판, 아자젤 결박·어둠·최종 심판의 불, 지상 타락의 귀인화(‘Azâzêl에게 모든 죄’).

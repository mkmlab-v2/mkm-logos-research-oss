...
- latest run id: `23643309446`
- conclusion: `success`
- URL: `https://github.com/mkmlab-v2/mkm-destiny-ai-41e38ec6/actions/runs/23643309446`

재확인:

```powershell
gh run view 23643309446 --repo mkmlab-v2/mkm-destiny-ai-41e38ec6 --json status,conclusion,workflowName,url
```

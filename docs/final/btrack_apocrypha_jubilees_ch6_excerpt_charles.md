# B-Track — 희년서 제6장 달력 핵심 (R.H. Charles 영역, 발췌)

**역할**: NotebookLM·로컬 RAG용 **1차 발췌**. 시장 데이터 없음.

**번역·호스트**: R.H. Charles, *The Book of Jubilees* 영역(전통적으로 퍼블릭 도메인 계열로 인용됨). 호스트: Wesley Center for Applied Theology (NNU) 비정경 문헌 페이지.

**정본 주의**: 완전한 학술 작업은 게즈어(Geʻez) 본·VanderKam 등 비판판과 대조할 것.

**온라인 전문(동일 번역 흐름)**: http://wesley.nnu.edu/sermons-essays-books/noncanonical-literature/noncanonical-literature-ot-pseudepigrapha/the-book-of-jubilees/

---

## Jubilees Chapter 6 (excerpt: 29–38, heavenly tablets / 364 days)

아래 문단은 위 URL HTML에서 **제6장**에 해당하는 연속 구절을 옮긴 것이다(번호는 원문과 동일).
...
34 And all the children of Israel will forget and will not find the path of the years, and will forget the new moons, and seasons, and sabbaths
...
36 and walk according to the feasts of the Gentiles after their error and after their ignorance.

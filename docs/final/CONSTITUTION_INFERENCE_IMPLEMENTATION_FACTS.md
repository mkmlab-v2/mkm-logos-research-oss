...
SSOT: `docs/final/TRACK_C_IP_BUSINESS_PLAN_2026-04-17.md` §3.0b–§3.0c · `MKM_UNIVERSAL_ROOT_INVESTOR_FACT_LOCK_CORRECTION_APPENDIX_EN_V1.md` · `.cursor/rules/dual-plane-kpi-non-merge-v1.mdc`.

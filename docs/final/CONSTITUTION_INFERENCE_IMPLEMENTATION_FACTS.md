...
| Logos OSS premarket export v1 (open-core harness) | `scripts/build_logos_oss_public_export_bundle_v1.py` · `scripts/run_logos_oss_premarket_smoke_v1.py` | manifest `docs/final/artifacts/logos_oss_public_export_manifest_v1.json`; public policy `logos_oss_release_policy_v1.json`; materialize `exports/mkm-logos-research-oss-v1/`; CI `.github/workflows/logos-oss-premarket-smoke.yml`; **monorepo `Push-GitHub-Explicit` 전체 push ≠ curated export**; deny KRV/Gnosis full/trading |

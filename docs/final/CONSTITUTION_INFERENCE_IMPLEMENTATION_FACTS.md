...
| MKM inter-agent parallel lanes (B) | `scripts/Invoke-MkmInterAgentParallelLanes_v1.ps1` | 병렬: `run_compression_low_saving_local_cap_sweep_v1.py` + `run_mkm_inter_agent_dialogue_routing_compare_v1.py`(health·routing A/B). 산출: `compression_low_saving_local_cap_sweep_v1_latest.json` · `mkm_inter_agent_dialogue_routing_compare_latest.json` |

...
### 1.0.5 세계관·철학 헌법 (지휘관 고정 · 2026-05-20)

**SSOT:** `docs/final/MKM_WORLDVIEW_AND_PHILOSOPHY_CONSTITUTION_V1.md` — 지휘관 **의도·세계관·신앙적 서사·AI 우주 모방**의 단일 앵커. 구현·경로·수치·벤치 통과 여부는 **본 문서가 아니라** 상단 목적·§1.1 이하·호출 가능 스크립트·아티팩트만.
...
| 수리 | 75식=**인덱스**; **24+4 FACT** 인용; 51 UNRECOVERED | `MKM12_75_FORMULAS_SSOT_V1.md` · `mkm12_75_formulas_ssot_v1_latest.json` |

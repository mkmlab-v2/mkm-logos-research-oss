...
| Logos insight bundle v1 (계약·minimal) | `docs/final/schemas/logos_insight_bundle_v1.schema.json` · `docs/final/schemas/logos_insight_bundle_v1.minimal.example.json` · `tests/test_logos_insight_bundle_schema_v1.py` | 업스트림 집계·중립 `tension_axis_id`·`citation_pack`·`[HYPO]`·NON_GATING; **빌더 `build_logos_*`는 후속** |

# B-Track Pure — 1에녹 심판·정화 서사 (Ch. 10 연계 · Ch. 12·18 발췌)

**범위**: 고대 문헌 자체의 목소리만. 시장·암호화폐·16상 매핑 **없음**.

## 출처

R.H. Charles 영역, *The Book of Enoch*, Wikisource.

- 제10장(아자젤·라파엘): `btrack_apocrypha_1enoch_ch10_excerpt.md` 참조.
- 제12장: https://en.wikisource.org/wiki/The_Book_of_Enoch_(Charles)/Chapter_12
- 제18장: https://en.wikisource.org/wiki/The_Book_of_Enoch_(Charles)/Chapter_18

## 제12장 발췌 (Watchers에게 선언 — 평화 없음·파괴의 대가)
...
- 파괴(earth) ↔ 화평·용서 불가(12장)
- 자녀·사랑하는 이의 멸망을 보는 형벌(12장)
- 심연·불·감옥(18장)
- 명령 위반·정해진 때(appointed times) 불이행(18장)
- 죄의 시한이 차기까지 구속(18장)

...
```json
{
  ...
  "temporal": {
    ...
    "per_window": [
      ...
      },
      {
        ...
        "metrics": {
          ...
          "recent_era_warnings_count": 1,
          "recent_era_precrash_zone_precision": 0.0,
          "crash_warning_recall": 0.0,
          "warnings_count": 1,
          "warning_load_ratio": 0.002045,
          "false_alert_count": 1,
          "false_alert_density": 0.002045,
          "crash_event_count": 3,
          "direction_sign_from_lens": "neutral",
          "direction_score_from_lens": 0.0,
          "mean_composite_direction_score": 0.429669,
          "mean_cycle_resonance": 0.631818,
          "confidence_from_lens": 0.2
        }
      }
    ],
    "aggregate": {
      ...
      "avg_warning_load_ratio": 0.011747,
      "avg_false_alert_density": 0.009854,
      "cost_efficiency_score": 0.127666,
  ...
  "holdout": {
    ...
    "per_window": [
      ...
      },
      {
        ...
        "metrics": {
          ...
          "crash_warning_recall": 0.125,
          "warnings_count": 1,
          "warning_load_ratio": 0.004098,
          "false_alert_count": 0,
          "false_alert_density": 0.0,
          "crash_event_count": 8,
          "direction_sign_from_lens": "neutral",
          "direction_score_from_lens": 0.0,
          "mean_composite_direction_score": 0.46847,
    ...
    "aggregate": {
      "avg_crash_warning_recall": 0.697917,
      "avg_precrash_zone_precision": 0.645833,
      "avg_hit_direction_rate": 0.354167,
      "avg_warning_load_ratio": 0.015946,
      "avg_false_alert_density": 0.008097,
      "cost_efficiency_score": 0.593221,
      "pass_cost_gate": true
    }
  },
  "combined_all_windows": {
    ...
    "aggregate": {
      "avg_crash_warning_recall": 0.473485,
      "avg_precrash_zone_precision": 0.427656,
      "avg_hit_direction_rate": 0.31044,
      "avg_warning_load_ratio": 0.014147,
      "avg_false_alert_density": 0.00885,
      "cost_efficiency_score": 0.395545,
      "pass_cost_gate": true
    }
  },

...
- **no1kmedi / mkmlife.com 경로·VPS PM2·Hostinger 수동 배포**: `docs/final/NO1KMEDI_MKMLIFE_REPO_PATH_SSOT_2026-04-08.md` — 로컬 `C:\workspace` 트리와 분리된 `E:\workspace\mkm-life\deploy-to-hostinger.ps1` 등 **실측 경로** 정리; **UI 면책 배지 초안**은 동 문서 **§10**. jema12 런북과 혼용 금지.

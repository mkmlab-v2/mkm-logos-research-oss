...
- **도메인별 쇼룸·랜딩 역할:** `docs/final/MKM_DOMAIN_PORTFOLIO_POINTER_V1.md` §1.1 — 전광판(jemaai)·제품(mkmlife)·브랜드 허브(jema-ai.com) 등 배치; 동 파일 §1 도메인 표와 혼동 금지.
